# -*- coding: utf-8 -*-
# SEED Emotion Classification Demo (MetaBCI unified pipeline)
#
#   dataset  -> metabci.brainda.datasets.SEEDEmotionDataset
#   paradigm -> metabci.brainda.paradigms.Emotion
#   model    -> metabci.brainda.algorithms.decomposition.FBMultiCSP + SVC
...
srate = 200
wp = [(1, 4), (4, 8), (8, 14), (14, 31)]
ws = [(0.5, 4.5), (3, 9), (6, 16), (12, 33)]
...
estimator = make_pipeline(
    FBMultiCSP(n_components=2, multiclass="ovr", filterbank=filterbank),
    SVC(),
)
